...
public class TravelCost 
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Price per gallon of gas: ");
        String price  = in.nextLine();
        Intiger.parseInt(price);

        Scanner in2 = new Scanner(System.in);
        System.out.println("Price per kWh of electriity: ");
        String price_electricity  = in.nextLine();
        Intiger.parseInt(price_electricity);

        Scanner in3 = new Scanner(System.in);
        System.out.println("How many miles is your trip? ");
        String miles  = in.nextLine();
        Intiger.parseInt(miles);
