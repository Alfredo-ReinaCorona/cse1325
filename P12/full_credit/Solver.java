...
public class Solver {
    public static void main(String[] args) {
        double  min = -100000000;           // Start searching for roots at x = min
        double  max = 100000000;            // Stop  searching for roots at x = max
        double  slices = 250000000;    // Check this many points between min and max
